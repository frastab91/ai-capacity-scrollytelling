...
export default function AccessSection() {
  ...
  return (
    <div ref={containerRef} className="scrolly-container access-scrolly-section">
          ...
          <svg viewBox={svgViewBox} width="100%" height="100%">
            ...
            <g className="door-panels" transform="translate(400, 300)">
              ...
              <g className="door-panel connectivity-panel" transform="translate(0, 0)">
                ...
                <rect className="panel-border-glow" x="-84" y="-164" width="168" height="104" rx="6" fill="none" stroke="#b28d46" strokeWidth="2" style={{ opacity: 0 }} />
              ...
              <g className="door-panel models-panel" transform="translate(0, 0)">
                ...
                <rect className="panel-border-glow" x="-84" y="-52" width="168" height="104" rx="6" fill="none" stroke="#b28d46" strokeWidth="2" style={{ opacity: 0 }} />
              ...
              <g className="door-panel data-panel" transform="translate(0, 0)">
                ...
                <rect className="panel-border-glow" x="-84" y="60" width="168" height="104" rx="6" fill="none" stroke="#b28d46" strokeWidth="2" style={{ opacity: 0 }} />
