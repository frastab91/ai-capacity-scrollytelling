        ...
        <div className="graphic-wrapper">
          <svg viewBox="0 0 800 600" width="100%" height="100%">
            ...
            <g className="receiver-panel-group">
              {/* Outer border panel */}
              <rect x="60" y="50" width="310" height="360" rx="10" fill="hsla(210, 20%, 94%, 0.85)" stroke="var(--color-border)" stroke-width="1.5" />
              ...
              <g transform="translate(115, 140)">
                <rect x="0" y="0" width="200" height="42" rx="6" fill="#ffffff" stroke="var(--color-border)" stroke-width="1" />
                <line x1="20" y1="21" x2="180" y2="21" stroke="var(--color-border)" stroke-width="0.8" stroke-dasharray="2 2" />
                {/* Cloud Icon */}
              ...
              <g transform="translate(115, 260)" className="recipient-box">
                <rect x="0" y="0" width="200" height="42" rx="6" fill="#ffffff" stroke="var(--color-accent)" stroke-width="1.5" />
                <g transform="translate(15, 11) scale(0.8)">
                ...
                <text x="115" y="25" className="svg-box-text" fill="var(--color-text)" font-weight="700">Passive Consumer</text>
              </g>
            ...
            <g className="author-panel-group" transform="translate(80, 40) scale(0.85)" opacity="0">
              {/* Outer border panel */}
              <rect x="430" y="50" width="310" height="360" rx="10" fill="hsla(38, 40%, 95%, 0.85)" stroke="var(--color-gold)" stroke-width="1.5" />
              ...
              <g transform="translate(485, 260)" className="creator-box">
                <rect x="0" y="0" width="200" height="42" rx="6" fill="#ffffff" stroke="var(--color-accent-green)" stroke-width="1.5" />
                <g transform="translate(15, 11) scale(0.8)">
                ...
                <text x="115" y="25" className="svg-box-text" fill="var(--color-text)" font-weight="700">Active Co-creators</text>
              </g>
